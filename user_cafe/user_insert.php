...
// $stmt->bindValue(':imgdat', $imgdat, PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
// $stmt->bindValue(':mime', $mime, PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
